...
export declare abstract class Settings implements IDisposer, IAnimation, IStartAnimation {
    ...
    protected _computedProperties: Dirty<this["_settings"]>;
    /**
     ...
     * @since 5.20.4
     */
    once<Key extends keyof this["_settings"]>(key: Key, callback: (value: this["_settings"][Key], target?: this, key?: Key) => void): IDisposer;
     ...
     * @since 5.20.4
     */
    onceDebounced<Key extends keyof this["_settings"]>(key: Key, callback: (value: this["_settings"][Key], target?: this, key?: Key) => void, debounceDelay: number): IDisposer;
    /**
     ...
     */
    protected _setAnimated<Key extends keyof this["_settings"]>(key: Key, value: this["_settings"][Key]): void;
...
export declare class Entity extends Settings implements IDisposer {
     ...
     * @return            Setting value
     */
    _setC<Key extends keyof this["_settings"], Value extends this["_settings"][Key]>(key: Key, value: Value): Value;
    /**
     ...
     * @param   value     Setting value
     */
    _setCRaw<Key extends keyof this["_settings"], Value extends this["_settings"][Key]>(key: Key, value: Value): void;
    /**
     ...
     * @return        Itself
     */
    _markC<T extends Entity>(this: T, ...keys: Array<keyof T["_settings"]>): T;
    /**
     ...
     * @param   settings  Settings
     */
    _setCAll(settings: Partial<this["_settings"]>): void;
    /**
     ...
     * @return       Computed?
     */
    isComputedSetting<Key extends keyof this["_settings"]>(key: Key): boolean;
    /**
     * @ignore
     */
    setRaw<Key extends keyof this["_settings"], Value extends this["_settings"][Key]>(key: Key, value: Value): void;
