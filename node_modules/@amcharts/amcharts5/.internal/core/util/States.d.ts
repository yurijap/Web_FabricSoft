...
export declare class State<E extends Entity> {
     ...
     * @ignore
     */
    _setCRaw<Key extends keyof E["_settings"]>(key: Key, value: E["_settings"][Key]): void;
    _setC<Key extends keyof E["_settings"]>(key: Key, value: E["_settings"][Key]): void;
    /**
...
export declare class States<E extends Entity> {
     ...
     * @return            New State
     */
    _createC(name: string, settings: Partial<E["_settings"]>): State<E>;
    /**
