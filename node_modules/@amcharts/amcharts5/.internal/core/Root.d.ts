...
export interface IRootSettings {
    ...
    /**
     * Default font family for all text elements, unless overridden on an element.
     *
     * @since 5.20.2
     */
    fontFamily?: string;
    /**
     * Default font size for all text elements, unless overridden on an element.
     *
     * @since 5.20.2
     */
    fontSize?: number | string;
    /**
     * Default font weight for all text elements, unless overridden on an element.
     *
     * @since 5.20.2
     */
...
export declare class Root implements IDisposer {
     ...
     */
    _computedSettings: {
        [K in keyof IRootSettings]?: boolean;
    };
     ...
     * @ignore
     */
    _reapplySettings(): void;
    /**
     * Root's settings.
     */
    get settings(): IRootSettings;
    private _render;
    private _runTickers;
