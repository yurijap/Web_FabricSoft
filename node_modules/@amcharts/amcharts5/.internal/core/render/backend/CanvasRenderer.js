...
export class CanvasText extends CanvasDisplayObject {
    ...
    _measure(status) {
        ...
        if (oversizedBehavior !== "none") {
            const ratio = this._fitRatio(bounds, oversizedBehavior == "truncate");
            if (ratio < 1) {
    ...
    _fitRatio(bounds, horizontalOnly = false) {
        const maxW = this.style.maxWidth;
        const maxH = horizontalOnly ? undefined : this.style.maxHeight;
...
export class CanvasRenderer extends ArrayDisposer {
    ...
    */
    ...
    _dispatchMousedown(originalEvent, originalTarget) {
        ...
        // Target-independent, mirroring globalpointermove/globalpointerup.
        this._dispatchEventAll("globalpointerdown", event);
    }
    ...
    _initEvent(key) {
        switch (key) {
            ...
            */
            // Must share the "pointerdown" bundle: a separate one would win the
            // slot and leave later subscribers without dragmove/dragend.
