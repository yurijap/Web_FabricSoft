...
export class Venn extends Series {
    constructor() {
         ...
         */
        this.slicesContainer = this.children.push(Container.new(this._root, {}));
        /**
         ...
         */
        this.hoverGraphics = this.slicesContainer.children.push(Graphics.new(this._root, { position: "absolute", isMeasured: false }));
        /**
    ...
    _onDataClear() {
        super._onDataClear();
        // Reset the color/pattern sets so re-setting data rebuilds from the start
        // of the palette (matching the Hierarchy charts), instead of continuing to
        // step from where the previous data left off.
        const colors = this.get("colors");
        if (colors) {
            colors.reset();
        }
...
Venn.className = "Venn";
Venn.classNames = Series.classNames.concat([Venn.className]);
