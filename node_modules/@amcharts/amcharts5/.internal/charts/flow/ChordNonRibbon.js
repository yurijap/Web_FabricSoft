...
export class ChordNonRibbon extends Chord {
    ...
    _prepareChildren() {
        // `linkType` is read in `_updateLink`, which the base runs in a pass gated
        // by chord-changed/radius/nodeWidth; force it when the setting changes.
        if (this.isDirty("linkType")) {
