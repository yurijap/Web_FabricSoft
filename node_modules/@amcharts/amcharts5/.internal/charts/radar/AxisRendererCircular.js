...
export class AxisRendererCircular extends AxisRenderer {
    ...
    updateBullet(bullet, position, endPosition) {
        if (bullet) {
            ...
            if (sprite) {
                ...
                sprite._setCAll({ rotation: angle, x: radius * $math.cos(angle), y: radius * $math.sin(angle) });
            }
        }
    }
    /**
    ...
    updateFill(fill, position, endPosition) {
        if (fill) {
            ...
            fill._setCAll({ startAngle: startAngle, arc: endAngle - startAngle });
