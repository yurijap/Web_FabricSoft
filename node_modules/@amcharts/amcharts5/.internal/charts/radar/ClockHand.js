...
export class ClockHand extends Container {
    constructor() {
         ...
         */
        this.hand = this.children.push(Graphics.new(this._root, { themeTags: ["hand"] }));
        /**
         * A "pin" element (hand's base).
         *
         * @default Graphics.new()
         */
        this.pin = this.children.push(Graphics.new(this._root, { themeTags: ["pin"] }));
    }
    _afterNew() {
        this._settings.themeTags = $utils.mergeTags(this._settings.themeTags, ["clock"]);
        super._afterNew();
        // to be redrawn when size changes
        this._setC("width", percent(1));
        this.adapters.add("x", () => {
            return 0;
        });
        this.adapters.add("y", () => {
...
ClockHand.className = "ClockHand";
ClockHand.classNames = Container.classNames.concat([ClockHand.className]);
