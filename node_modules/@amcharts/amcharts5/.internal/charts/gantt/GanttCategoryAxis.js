...
export class GanttCategoryAxis extends CategoryAxis {
    constructor() {
         ...
         */
        this.xButton = this.children.push(Button.new(this._root, {
            themeTags: ["xbutton"],
    ...
    _afterNew() {
        ...
        containersTemplate.events.on("dragstop", (e) => {
            ...
            renderer.containers.each((container) => {
                container._setC("forceInactive", false);
            });
        });
        let startY = 0;
        containersTemplate.events.on("dragstart", (e) => {
            ...
            const renderer = this.get("renderer");
            renderer.containers.each((container) => {
                container._setC("forceInactive", true);
            });
            startY = e.target.y();
        });
    }
    ...
    _afterDataChange() {
        ...
        if (chart) {
            ...
            this._setC("maxZoomCount", maxZoomCount);
            this._setC("minZoomCount", maxZoomCount);
...
GanttCategoryAxis.className = "GanttCategoryAxis";
GanttCategoryAxis.classNames = CategoryAxis.classNames.concat([GanttCategoryAxis.className]);
