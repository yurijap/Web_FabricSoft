...
export class GanttCategoryAxisRenderer extends AxisRendererY {
    constructor() {
         ...
         */
        this.labels = this.addDisposer(new ListTemplate(Template.new({}), () => EditableAxisLabel._new(this._root, {
         ...
         * @default new ListTemplate<Container>
         */
        this.controlsContainers = this.addDisposer(new ListTemplate(Template.new({}), () => Container._new(this._root, {
         ...
         */
        this.grips = this.addDisposer(new ListTemplate(Template.new({}), () => Rectangle._new(this._root, {
         ...
         */
        this.progressPies = this.addDisposer(new ListTemplate(Template.new({}), () => ProgressPie._new(this._root, {
         ...
         */
        this.taskBullets = this.addDisposer(new ListTemplate(Template.new({}), () => Button._new(this._root, {
            toggleKey: "active",
         ...
         */
        this.durationSteppers = this.addDisposer(new ListTemplate(Template.new({}), () => NumericStepper._new(this._root, {
...
GanttCategoryAxisRenderer.className = "GanttCategoryAxisRenderer";
GanttCategoryAxisRenderer.classNames = AxisRendererY.classNames.concat([GanttCategoryAxisRenderer.className]);
