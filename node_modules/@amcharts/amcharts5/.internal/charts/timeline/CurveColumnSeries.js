...
export class CurveColumnSeries extends BaseColumnSeries {
    constructor() {
         ...
         */
        this.columns = this.addDisposer(new ListTemplate(Template.new({}), () => Polygon._new(this._root, {
            position: "absolute",
...
CurveColumnSeries.className = "CurveColumnSeries";
CurveColumnSeries.classNames = BaseColumnSeries.classNames.concat([CurveColumnSeries.className]);
