...
export class SerpentineChart extends CurveChart {
    _prepareChildren() {
        ...
        if (this.isDirty("levelCount") || this.isDirty("orientation") || this.isDirty("yAxisRadius") || this.isDirty("startLocation") || this.isDirty("endLocation")) {
            this._updateMasks();
        }
    }
    _updateMasks() {
        ...
        this.yAxes.each((axis) => {
            ...
            renderer._setC("axisLength", $utils.relativeToValue(this.get("yAxisRadius", p50), 2 * radius));
            axis.markDirtySize();
        });
...
SerpentineChart.className = "SerpentineChart";
SerpentineChart.classNames = CurveChart.classNames.concat([SerpentineChart.className]);
