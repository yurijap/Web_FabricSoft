...
export class LineArrowSeries extends SimpleLineSeries {
    constructor() {
        super(...arguments);
        this._arrows = [];
        this.arrows = this.addDisposer(new ListTemplate(Template.new({}), () => Triangle._new(this._root, { themeTags: ["arrow"] }, [this.arrows.template])));
    }
    _afterNew() {
        super._afterNew();
...
LineArrowSeries.className = "LineArrowSeries";
LineArrowSeries.classNames = SimpleLineSeries.classNames.concat([LineArrowSeries.className]);
