...
export class SimpleLineSeries extends DrawingSeries {
    constructor() {
        super(...arguments);
        this._tag = "line";
        this._updateExtension = false;
        this.lines = this.addDisposer(new ListTemplate(Template.new({}), () => Line._new(this._root, {}, [this.lines.template])));
        this.hitLines = this.addDisposer(new ListTemplate(Template.new({}), () => Line._new(this._root, {}, [this.hitLines.template])));
        this._di = [];
        this._lines = [];
        this._hitLines = [];
    }
...
SimpleLineSeries.className = "SimpleLineSeries";
SimpleLineSeries.classNames = DrawingSeries.classNames.concat([SimpleLineSeries.className]);
