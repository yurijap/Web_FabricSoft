...
export class PolylineSeries extends DrawingSeries {
    constructor() {
        super(...arguments);
        this._tag = "polyline";
        this._drawingLine = this.mainContainer.children.push(Line.new(this._root, { forceInactive: true }));
    }
    _prepareChildren() {
...
PolylineSeries.className = "PolylineSeries";
PolylineSeries.classNames = DrawingSeries.classNames.concat([PolylineSeries.className]);
