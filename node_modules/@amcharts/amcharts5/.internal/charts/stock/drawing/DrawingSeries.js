...
export class DrawingSeries extends LineSeries {
    constructor() {
        ...
        this.selectorContainer = this.children.push(Container.new(this.root, {}));
        this._selected = [];
        this._isSelecting = false;
        this._isMoving = false;
        // point index in segment
        this._pIndex = 0;
        this.grips = this.addDisposer(new ListTemplate(Template.new({}), () => Container._new(this._root, {
            themeTags: ["grip"],
            setStateOnChildren: true,
            draggable: true
        }, [this.grips.template])));
        this.circles = this.addDisposer(new ListTemplate(Template.new({}), () => Circle._new(this._root, {}, [this.circles.template])));
        this.outerCircles = this.addDisposer(new ListTemplate(Template.new({}), () => Circle._new(this._root, {
            themeTags: ["outline"]
        }, [this.outerCircles.template])));
        this.selectors = this.addDisposer(new ListTemplate(Template.new({}), () => Rectangle._new(this._root, {
            themeTags: ["selector"]
    ...
    _afterNew() {
        ...
        this.bulletsContainer.states._createC("hidden", { visible: true, opacity: 0 });
...
DrawingSeries.className = "DrawingSeries";
DrawingSeries.classNames = LineSeries.classNames.concat([DrawingSeries.className]);
