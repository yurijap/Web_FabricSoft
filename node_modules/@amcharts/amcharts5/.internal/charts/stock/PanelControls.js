...
export class PanelControls extends Container {
    constructor() {
         ...
         * @default Button.new()
         */
        this.upButton = this.children.push(Button.new(this._root, {
         ...
         * @default Button.new()
         */
        this.downButton = this.children.push(Button.new(this._root, {
         ...
         * @default Button.new()
         */
        this.expandButton = this.children.push(Button.new(this._root, {
         ...
         * @default Button.new()
         */
        this.closeButton = this.children.push(Button.new(this._root, {
...
PanelControls.classNames = Container.classNames.concat([PanelControls.className]);
