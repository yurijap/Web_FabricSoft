...
export class RelativeStrengthIndex extends OverboughtOversold {
    _afterNew() {
        ...
        this._setEditableSettingBounds("overBought", 60, 90, 1);
        this._setEditableSettingBounds("overSold", 10, 40, 1);
...
RelativeStrengthIndex.className = "RelativeStrengthIndex";
RelativeStrengthIndex.classNames = OverboughtOversold.classNames.concat([RelativeStrengthIndex.className]);
