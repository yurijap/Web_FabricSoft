...
export class StockLegend extends Legend {
    constructor() {
         ...
         */
        this.closeButtons = this.addDisposer(new ListTemplate(Template.new({}), () => Button._new(this._root, {
         ...
         * @default new ListTemplate<Button>()
         */
        this.settingsButtons = this.addDisposer(new ListTemplate(Template.new({}), () => Button._new(this._root, {
...
StockLegend.className = "StockLegend";
StockLegend.classNames = Legend.classNames.concat([StockLegend.className]);
