...
export class ColorPicker extends Container {
    constructor() {
        super(...arguments);
        this._clickOverlay = this.children.push(Rectangle.new(this._root, {
            position: "absolute",
            fillOpacity: 0,
            interactive: true,
            isMeasured: false,
        ...
        this.rectangles = new ListTemplate(Template.new({}), () => RoundedRectangle._new(this._root, {}, [this.rectangles.template]));
        /**
         * Container for color gradients.
         */
        this.gradientsContainer = this.children.push(Container.new(this._root, {
         ...
         * @ignore
         */
        this.colorGradientsContainer = this.gradientsContainer.children.push(Container.new(this._root, {
            width: p100,
            layer: 0
        }));
        /**
         ...
         * @ignore
         */
        this.colorRectangle = this.colorGradientsContainer.children.push(Rectangle.new(this._root, {
            crisp: true,
         ...
         * @ignore*
         */
        this.colorRectangleWhiteOverlay = this.colorGradientsContainer.children.push(Rectangle.new(this._root, {
            crisp: true,
            forceInactive: true,
            width: p100,
            height: p100
         ...
         * @ignore
         */
        this.colorRectangleBlackOverlay = this.colorGradientsContainer.children.push(Rectangle.new(this._root, {
            crisp: true,
            forceInactive: true,
            width: p100,
            height: p100
         ...
         */
        this.slider = this.gradientsContainer.children.push(Slider.new(this._root, {
         ...
         * @ignore
         */
        this.inputContainer = this.children.push(Container.new(this._root, {
            marginTop: 10,
            layout: this._root.horizontalLayout,
            width: p100
        }));
         ...
         */
        this.pickerButton = this.inputContainer.children.push(Button.new(this._root, {
         ...
         */
        this.noColorButton = this.inputContainer.children.push(Button.new(this._root, {
         ...
         */
        this.colorInput = this.inputContainer.children.push(EditableLabel.new(this._root, {
            themeTags: ["input", "color"]
        }));
        /**
         * @ignore
         */
        this.opacityContainer = this.children.push(Container.new(this._root, {
            width: p100,
            marginTop: 10,
            layout: this._root.horizontalLayout
        }));
         ...
         */
        this.opacitySlider = this.opacityContainer.children.push(Slider.new(this._root, {
            themeTags: ["opacity"],
         ...
         */
        this.targetCircle = this.colorGradientsContainer.children.push(Circle.new(this._root, {
         ...
         * @ignore
         */
        this.buttonsContainer = this.children.push(Container.new(this._root, {
            marginTop: 10,
            layout: this._root.horizontalLayout,
            width: p100
        }));
         ...
         */
        this.cancelButton = this.buttonsContainer.children.push(Button.new(this._root, {
            themeTags: ["cancel"],
         ...
         */
        this.okButton = this.buttonsContainer.children.push(Button.new(this._root, {
            themeTags: ["ok"],
            label: Label.new(this._root, {})
        }));
...
ColorPicker.classNames = Container.classNames.concat([ColorPicker.className]);
