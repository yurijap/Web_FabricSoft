...
export declare function getRandomFn(): () => number;
export declare function getRandom(): number;
export declare function getRandomInRange(min: number, max: number): number;
...
export declare function randomInRangeValue(r: RangeValue): number;
