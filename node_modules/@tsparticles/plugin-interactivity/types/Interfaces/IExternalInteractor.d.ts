import type { IDelta, IOptionLoader, Particle, RecursivePartial } from "@tsparticles/engine";
...
export interface IExternalInteractor<TParticle extends Particle = Particle> extends IParticleInteractorBase<TParticle> {
    ...
    loadModeOptions?: (options: IModes & IOptionLoader<IModes>, ...sources: RecursivePartial<IModes | undefined>[]) => void;
