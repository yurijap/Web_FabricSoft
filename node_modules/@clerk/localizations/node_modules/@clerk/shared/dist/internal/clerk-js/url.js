...
*/
const isVirtualRouterPath = (to) => to.includes(VIRTUAL_ROUTER_BASE_PATH);
...
//#endregion
exports.VIRTUAL_ROUTER_BASE_PATH = VIRTUAL_ROUTER_BASE_PATH;
...
exports.isVirtualRouterPath = isVirtualRouterPath;
