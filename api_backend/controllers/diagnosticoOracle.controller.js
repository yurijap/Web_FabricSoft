...
function buildResult(answers) {
  ...
  const knowledgeTransfer = normalizeText(answerMap[12]);
  ...
  const patterns = [
    ...
    ['dependencia alta de la consultora', 'sin transferencia real'].includes(knowledgeTransfer) && 'Conocimiento no transferido al equipo interno',
  ].filter(Boolean);
